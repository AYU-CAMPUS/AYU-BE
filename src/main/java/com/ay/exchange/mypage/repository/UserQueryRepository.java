...
//        //교환 수락 타입을 2로 변경
//        Long count = queryFactory.update(exchange)
...
//                ", u.exchange_success_count=u.exchange_success_count+1 WHERE b.board_id=? AND u.user_id = ?";
//        Query query = em.createNativeQuery(sql)
//                .setParameter(1, exchangeRequest.getBoardId())
//                .setParameter(2, exchangeRequest.getApplicantId());
