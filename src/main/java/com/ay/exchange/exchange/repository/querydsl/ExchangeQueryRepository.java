...
public class ExchangeQueryRepository {
    ...
    public int requestExchange(ExchangeRequest exchangeRequest, String boardOwnerEmail, String email, String currentDate) {
        ...
        Query query = em.createNativeQuery(sql)
                ...
                .setParameter(7, boardOwnerEmail)
                ...
                .setParameter(12, boardOwnerEmail)
