...
public class AwsS3Service {
    ...
    public String uploadFile(MultipartFile multipartFile, String userId){
        ...
        String fileName=buildFileName(multipartFile.getOriginalFilename(), userId);
    ...
    private String buildFileName(String originalFileName, String userId){
        int fileExtensionIndex = originalFileName.lastIndexOf(FILE_EXTENSION_SEPARATOR);
        String fileExtension=originalFileName.substring(fileExtensionIndex);
        String fileName=originalFileName.substring(0,fileExtensionIndex);
        String now=String.valueOf(System.currentTimeMillis());

        return userId+ "/" + fileName + "_" + now + fileExtension;
    }
